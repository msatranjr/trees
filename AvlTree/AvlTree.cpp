...
template <class T>
void TreeNode<T>::RotateDoubleLeft()
{
...
template <class T>
void TreeNode<T>::RotateDoubleRight()
{
...
BalanceRequirement TreeNode<T>::BalanceCheck()
{
	//if (subroot == 0)
	//{
	//	return None;
...
template <class T>
void TreeNode<T>::Delete(T value)
{
	//Node* root = *rootPtr;
